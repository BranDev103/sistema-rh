...
-->
        ...
        <div class="form-group">
          ...
          <select name="nombre_obra" required>
            ...
            <option value="EDIFICACIÓN DESTINADO A LA EDIFICACIÓN DE 954  (NOVECIENTAS CINCUENTA Y CUATRO) VIVIENDAS EN EL PROYECTO PRELIMINAR POLÍGONO UBICADO EN EL MUNICIPIO DE TEPEJI DEL RÍO DE OCAMPO, EN HIDALGO" <?php if ($empleado['nombre_obra'] == "EDIFICACIÓN DESTINADO A LA EDIFICACIÓN DE 954  (NOVECIENTAS CINCUENTA Y CUATRO) VIVIENDAS EN EL PROYECTO PRELIMINAR POLÍGONO UBICADO EN EL MUNICIPIO DE TEPEJI DEL RÍO DE OCAMPO, EN HIDALGO") echo "selected"; ?>>
            ...
            <option value="EDIFICACIÓN DESTINADO A LA EDIFICACIÓN DE 180  (CIENTO OCHENTA) VIVIENDAS EN EL PROYECTO PRELIMINAR POLÍGONO UBICADO EN EL MUNICIPIO DE TEPEJI DEL RÍO DE OCAMPO, EN HIDALGO" <?php if ($empleado['nombre_obra'] == "EDIFICACIÓN DESTINADO A LA EDIFICACIÓN DE 180  (CIENTO OCHENTA) VIVIENDAS EN EL PROYECTO PRELIMINAR POLÍGONO UBICADO EN EL MUNICIPIO DE TEPEJI DEL RÍO DE OCAMPO, EN HIDALGO") echo "selected"; ?>>
              EDIFICACIÓN DESTINADO A LA EDIFICACIÓN DE 180 (CIENTO OCHENTA) VIVIENDAS EN EL PROYECTO PRELIMINAR POLÍGONO UBICADO EN EL MUNICIPIO DE TEPEJI DEL RÍO DE OCAMPO, EN HIDALGO
            </option>
            <option value="EDIFICACIÓN DESTINADO A LA EDIFICACIÓN DE 260  (DOSCIENTAS SESENTA) VIVIENDAS EN EL PROYECTO RESERVA 2 UBICADO EN EL MUNICIPIO DE TEPEJI DEL RÍO DE OCAMPO, EN HIDALGO" <?php if ($empleado['nombre_obra'] == "EDIFICACIÓN DESTINADO A LA EDIFICACIÓN DE 260  (DOSCIENTAS SESENTA) VIVIENDAS EN EL PROYECTO RESERVA 2 UBICADO EN EL MUNICIPIO DE TEPEJI DEL RÍO DE OCAMPO, EN HIDALGO") echo "selected"; ?>>
